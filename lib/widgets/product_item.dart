...
class _CustomProductListItemState extends State<CustomProductListItem> with SingleTickerProviderStateMixin {
      ...
      child: Card(
        ...
        child: Container(
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(10),
              image: DecorationImage(image: CachedNetworkImageProvider(widget.product.image), fit: BoxFit.cover)),
        ),
      ),
    );
  }
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      ...
                      if (widget.onAddToCart != null) {
                        final RenderBox box = onTapKey.currentContext.findRenderObject();
                              ...
                              children: <Widget>[
                                Column(
                                  ...
                                  children: <Widget>[
                                    Text(
                                      'Total',
                                      style: TEXT_STYLE_ON_FOREGROUND.copyWith(fontSize: 14),
                                    ),
                                    SizedBox(
                                      height: 5,
                                    ),
                                ...
                                Container(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      Container(
                                        child: Text(
                                          numberToMoneyString(widget.cartItem.product.price * widget.cartItem.count).toString() ?? '0đ',
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                              letterSpacing: 1.2, color: widget.priceTextColor, fontSize: 16, fontWeight: FontWeight.bold),
                                        ),
                                      ),
                                      SizedBox(
                                        height: 5,
                                        ...
                                        children: <Widget>[
                                          CustomOnTapWidget(
                                            ...
                                            child: Container(
                                              ...
                                              decoration: BoxDecoration(
                                                  color: BACKGROUND_COLOR.withOpacity(0.5), borderRadius: BorderRadius.circular(15)),
                                            ...
                                            child: Container(
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration.collapsed(hintText: '').copyWith(
                                                    hintText: '', isDense: true, contentPadding: EdgeInsets.symmetric(horizontal: 5)),
                                              ),
                                            ),
                                          ),
                                          CustomOnTapWidget(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: <Widget>[
                          Text('Price:', style: TEXT_STYLE_ON_FOREGROUND.copyWith(fontSize: 14, fontWeight: FontWeight.bold)),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: <Widget>[
                          Text('Quantity:', style: TEXT_STYLE_ON_FOREGROUND.copyWith(fontSize: 14, fontWeight: FontWeight.bold)),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: <Widget>[
                          Text('Total:', style: TEXT_STYLE_ON_FOREGROUND.copyWith(fontSize: 14, fontWeight: FontWeight.bold)),
                          Text('${numberToMoneyString(cartItem.count * cartItem.product.price)}',
                              textAlign: TextAlign.end,
                              style: TEXT_STYLE_ON_FOREGROUND.copyWith(fontSize: 18, fontWeight: FontWeight.bold, color: priceTextColor)),
                        ],
                      )
                    ],
                  ),
