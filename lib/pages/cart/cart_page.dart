          ...
          builder: (context, state) {
            ...
            return Stack(
              children: <Widget>[
                ...
                // Align(alignment: Alignment.bottomCenter, child: buildNavigation(state.cart))
              ],
            );
            // }
                          ...
                          CustomOnTapWidget(
                            onTap: () async {
                              if (currentLogin == null) {
                                Navigator.pushReplacement(context, MaterialPageRoute(builder: (b) => LoginPage()));
                              } else {
                            ...
                            child: Container(
                              ...
                              height: 55,
                              width: 90,
                              decoration: BoxDecoration(color: FOREGROUND_COLOR, borderRadius: BorderRadius.circular(5)),
                              child: Icon(
                                Icons.forward,
                                size: 25,
        ...
        child: Column(
          ...
          return Column(
            ...
            children: <Widget>[
              ...
              Container(
                child: Column(
                  children: orderingDetail.where((od) => od.orderingId == ordering.id).toList().map<Widget>((od) {
...
//                  bloc.add(AddToCart(productID: product.id, count: -1));
  ...
  _removeFromCartConfirmDialog({@required ProductModel product, @required Function onYes, Function onNo}) {
    showDialog(
        ...
        builder: (_) {
          return AlertDialog(
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(25), side: BorderSide(color: FOREGROUND_COLOR, width: 2)),
            backgroundColor: BACKGROUND_COLOR,
