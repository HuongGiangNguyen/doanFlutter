...
//              padding: EdgeInsets.only(top: ScreenHelper.getPaddingTop(context) + 30),
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      fit: BoxFit.cover,
                      image: CachedNetworkImageProvider('https://i.pinimg.com/originals/2e/0a/ab/2e0aaba94a7e19d5792021915604bc23.jpg'))),
              child: Container(
                padding: EdgeInsets.only(top: ScreenHelper.getPaddingTop(context) + 30),
...
//              )),
          Container(
            ...
            decoration: BoxDecoration(
                color: BACKGROUND_COLOR, borderRadius: BorderRadius.circular(10), border: Border.all(color: FOREGROUND_COLOR, width: 2)),
            child: TextFormField(
          ...
          Container(
            ...
            decoration: BoxDecoration(
                color: BACKGROUND_COLOR, border: Border.all(color: FOREGROUND_COLOR, width: 2), borderRadius: BorderRadius.circular(10)),
            child: TextFormField(
          ...
          Container(
            ...
            child: Text(
              ...
              style: TextStyle(color: PRIMARY_TEXT_COLOR.withOpacity(0.5), fontSize: 12),
            ),
          ),
          buildSocialLogin(),
          SizedBox(
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: RaisedButton(
            elevation: 0,
            shape: RoundedRectangleBorder(side: BorderSide(color: FOREGROUND_COLOR, width: 2), borderRadius: BorderRadius.circular(10)),
            onPressed: () {},
            color: BACKGROUND_COLOR,
            padding: EdgeInsets.all(10),
            child: Container(alignment: Alignment.center, child: Text('Register', style: TEXT_STYLE_PRIMARY)),
          ),
        ),
      ],
    );
