...
class _ProductDetailPageState extends State<ProductDetailPage> {
  ...
  ShopAccountBloc shopAccountBloc = ShopAccountBloc(ShopAccountLoading());
            ...
            if (state is ProductLoaded) {
              return Stack(
                children: <Widget>[
                  ...
                  Align(alignment: Alignment.topCenter, child: buildAppBar(state.product))
                ],
              );
              ...
              .map(
                (product) => Container(
                  ...
                  child: CustomProductGridItem(
                    ...
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (b) => ProductDetailPage(product))),
                    elevation: 5,
                    product: product,
                  ),
                ),
          ...
          return AnimatedSwitcher(
              ...
              child: snapshot.hasData && snapshot.data == true
                  ...
                  : Container(
                      ...
                      margin: EdgeInsets.only(top: ScreenHelper.getPaddingTop(context) + 5, left: 5, right: 5),
                      child: Row(
                          ...
                          Row(
                            children: <Widget>[
                              CustomAnimatedButton(
                                ...
                                elevation: 0,
                                color: BACKGROUND_COLOR,
                                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (b) => SearchPage())),
                                child: Container(
                                  height: 40,
                                  width: 40,
                                  alignment: Alignment.center,
...
//                    }),
                CustomOnTapWidget(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (b) => ShopAccountDetailPage(productModel.shopUsername)));
                  },
                  child: Text(
          ...
          Container(
              ...
              child: Container(
                ...
                child: Text(
                  productModel.name,
                  style: TEXT_STYLE_PRIMARY.copyWith(fontSize: 30, fontWeight: FontWeight.bold),
                ),
              )),
          Container(
              width: double.maxFinite,
              child: Container(
                ...
                child: Text(
                  ...
                  style: TEXT_STYLE_PRIMARY.copyWith(color: PRICE_COLOR_PRIMARY, fontSize: 25, fontWeight: FontWeight.bold),
                ),
              )),
          Container(
              width: double.maxFinite,
          ...
          Container(
              ...
              child: Theme(
                ...
                child: ExpansionTile(
                  ...
                  children: <Widget>[Container(margin: EdgeInsets.all(10), child: _buildCarousel(productModel.productImage))],
                ),
              )),
          Container(
              width: double.maxFinite,
                ...
                child: ExpansionTile(
                  ...
                  children: <Widget>[
                    Container(
                      margin: EdgeInsets.all(10),
                      child: Text(
                          productModel.description != null && productModel.description.length > 0 ? productModel.description : 'No Review',
                          style: TEXT_STYLE_PRIMARY),
                    )
                  ],
                ),
  ...
  Widget _buildCarousel(List<ProductImageModel> images) {
    ...
    if (images != null && images.length > 0) {
      return CustomOnTapWidget(
        onTap: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (b) => ImagesViewer(images.map((image) => Image.network(image.image)).toList())));
        },
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                ...
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: TEXT_STYLE_PRIMARY.copyWith(fontSize: 20, fontWeight: FontWeight.bold, color: PRICE_COLOR_PRIMARY),
                              ),
                            ],
                          ),
                        )
                            ...
                            children: <Widget>[
                              CustomOnTapWidget(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(color: FOREGROUND_COLOR, borderRadius: BorderRadius.circular(50)),
                                  child: Icon(
                                    Icons.remove,
                              ...
                              Center(
                                child: Container(
                                  ...
                                  alignment: Alignment.center,
                                  decoration: BoxDecoration(color: PRIMARY_COLOR.withOpacity(0.1), borderRadius: BorderRadius.circular(15)),
                                  child: TextFormField(
                                    // enabled: false,
                  ...
                  RaisedButton(
                    onPressed: () async {
                      ...
                      await showAddToCartAnimation(context,
                          overlayWidget: Container(
                            padding: EdgeInsets.all(5),
                            decoration: BoxDecoration(color: BACKGROUND_COLOR, borderRadius: BorderRadius.circular(100)),
                            child: Text(
                              quantityController.text,
                              style: TEXT_STYLE_PRIMARY.copyWith(fontWeight: FontWeight.bold),
                            ),
                          ),
                          start: CustomPosition(ScreenHelper.getWidth(context) * 0.7, ScreenHelper.getHeight(context) * 0.9),
                    ...
                    child: Container(
                        ...
                        child: Text(
                          'Add To Cart',
                          textAlign: TextAlign.center,
                          style: TEXT_STYLE_ON_FOREGROUND.copyWith(fontSize: 16),
                        )),
                  )
                ],
              ),
